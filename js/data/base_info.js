...
var map_option = {
    ...
    title: [
        {
            text: '销售分布情况',
            subtext: 'data from @易云',
            sublink: 'http://yiyun.zdata.co.nz',
            left: 'center',
            textStyle: {
                color: '#fff'
            }
...
function renderBrushed(params) {
    ...
    if(params) {
        ...
        for (var i = 0; i < mainSeries.dataIndex.length; i++) {
            ...
            var dataItem = getDataItem(rawIndex);
    ...
    if(selectedItems.length <= 0) {
        //top 20
        selectedItems = getConvertData().slice(0, 20).sort(function (a, b) {
            return a.value[2] - b.value[2];
        });
        count = 20;
    }
